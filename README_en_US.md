...
4) This program includes a quantitative test with console output, a statistical report on the number of elements generated. Open your browser's Inspect tool in the Console tab and discover the quantitative distribution of each generated element.
