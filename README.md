...
[^7]:Um teste razoável envolve 100 milhões de elementos no modo sílabas ou 50 mil elementos nos demais modos. O teste unitário é feito pra detectar falhas no PRNG do ambiente de execução, e uma falha do ambiente de execução NÂO É uma falha do código deste programa.
