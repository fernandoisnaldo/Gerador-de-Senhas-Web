...
4) Este programa vem com teste unitário ativado com saída pra console, abra o Inspecionar Elementos e descubra a distribuição de cada elemento gerado. Isso é um recurso pra detectar PRNG viciado.
