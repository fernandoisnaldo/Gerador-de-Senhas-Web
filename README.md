...
5) Está disponível em várias línguas: tem 1 página HTML pra cada língua suportada e 1 página HTML só pra [selecionar linguagem](https://fernandoisnaldo.github.io/Gerador-de-Senhas-Web/setLang.html). Todas com HTML semântico, sem muita frescura.
