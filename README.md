...
3) As senhas geradas possuem cores aleatórias dentro de uma palheta definida no código. (essas cores também são selecionadas via window.crypto.getRandomValues() para evitar confusões de auditoria)
