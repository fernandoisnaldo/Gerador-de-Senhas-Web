...
4) Design aleatório: As senhas tem suas cores sorteadas a cada geração, aproveitando o mesmo gerador criptograficamente seguro para ter estilo aleatório. Os caracteres gerados e as cores atribuídas são independentes, e se trata meramente de um recurso de web design.
