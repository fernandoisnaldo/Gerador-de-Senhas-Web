...
5) Está disponível em várias línguas: tem 1 página HTML pra cada uma suportada e 1 página HTML só pra [selecionar linguagem](https://fernandoisnaldo.github.io/Gerador-de-Senhas-Web/setLang.htmlselecionar idiomas). Todas com HTML semântico sem frescura.
