...
6) Design aleatório: As senhas tem suas cores sorteadas a cada geração, aproveitando o mesmo gerador criptograficamente seguro para ter estilo aleatório. Foi optado por um enviesamento para a cor verde nos detalhes, por isso ser meramente um recurso de design, sem implicações na segurança.
