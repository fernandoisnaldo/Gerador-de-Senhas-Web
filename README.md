...
4) Simplicidade máxima: Escrito da forma mais pura possível, baseado no limite do possível em código JavaScript nativo dos padrões W3C. Não há JQuery, nem React e nem outras frescuras pra enfeitar o código.
...
[^7]: As palavras foram obtidas da lista [Dice](https://www.eff.org/dice) da Electronic Frontier Foundation, e estão licenciadas sob os termos da [Creative Commons By 3.0](https://creativecommons.org/licenses/by/3.0/legalcode.en).
