...
4) As senhas tem suas cores sorteadas a cada geração, aproveitando o mesmo gerador criptograficamente seguro. Os caracteres gerados e as cores atribuídas são independentes.
